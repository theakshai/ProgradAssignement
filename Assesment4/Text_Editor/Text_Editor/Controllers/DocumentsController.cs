    ...
    public class DocumentsController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Documents != null ? 
                          ...
                          Problem("Entity set 'DocumentContext.Documents'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,UserId,DocumentId,Content,CreatedAt")] Document document)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,UserId,DocumentId,Content,CreatedAt")] Document document)
        {
            if (id != document.Id)
            {
                return NotFound();

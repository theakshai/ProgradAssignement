...
namespace TextEditor.Controllers
{
    public class DocumentsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,UserId,Title,Content")] Document document)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,UserId,Title,Content")] Document document)
        {
            if (id != document.Id)
            {
                return NotFound();
